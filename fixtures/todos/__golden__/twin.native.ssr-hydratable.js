...
export function Todos() {
 ...
 var _v$ = _$ssrHydrationKey(), _v$6 = _$escape(_$Show({
 get when() {
 ...
 children: (todo, i) => {
 var _v$11, _v$12;
 return _v$11 = _$ssrHydrationKey(), _v$12 = () => {
 return _$escape(todo.text);
 }, _$ssr(_tmpl$5, _v$11, _v$12);
 }
 })), _$ssr(_tmpl$, _v$3, _v$4, _v$5);
 }
 })), _v$2 = () => {
 return _$ssrAttribute("value", _$escape(text(), true));
 };
