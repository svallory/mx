 ...
 *    (`@mxlang/translator`, `@mxlang/astro`; `@mxlang/core` itself does not
...
const DEFAULT_POLICY: HostPolicy = { host: "translator" };
...
function isKnownHost(value: unknown): value is HostPolicy["host"] {
  return value === "translator" || value === "astro" || value === "solid";
}
