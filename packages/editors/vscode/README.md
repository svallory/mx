...
- **Highlighting**: Accurate syntax highlighting for `.mx` and `.amx` files powered by the Marko TextMate grammar. (Note: `.solid.mx` currently falls back to `source.tsx` highlighting due to regex grammar limitations).
