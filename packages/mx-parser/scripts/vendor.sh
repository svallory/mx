#!/usr/bin/env bash
# Re-vendors @babel/parser's TypeScript source into packages/mx-parser/src/babel/.
...
#   bun run build   (from packages/mx-parser)
#   bun run test    (from packages/mx-parser)
